  //_______________________________________________________
    ...
    function colorTrace(msg, color,back,ligne) {
      console.log("%c"+msg+" ligne:"+ligne,"background-color:"+back+";color:"+color +";font-weight:normal;");
      //jeremy de barros
    }
      ...
      $.ajax({ url: 'load.php',
       ...
       success: function(data) {
        ...
        for (var i = elements.length - 1; i >= 0; i--) {
          ...
          createElement($(elements[i]).attr('data-posx'),$(elements[i]).attr('data-posy'),$(elements[i]).attr('data-posw'),$(elements[i]).attr('data-posh'),
...
document.onmouseup=function(event){
 ...
 // colorTrace("length = "+document.getElementById("posting").innerHTML.length+"; content = "+document.getElementById("posting").innerHTML+';',"lightgreen","black",321);
  ...
  save("data",document.getElementById("posting").innerHTML);
