  ...
  //_______________________________________________________
      ...
      if(install==true && document.getElementById("getting").innerHTML!=''){
        ...
        for (var i = 0; i <= elements.length - 1; i++) {
          ...
          //function createElement(posX,posY,posZ,posW,posH,html){
            createElement("div","sketch",$(elements[i]).attr('d-px'),$(elements[i]).attr('d-py'),$(elements[i]).attr('d-pz'),$(elements[i]).attr('d-pw'),
    ...
    function installation(){
      ...
      if(b<elementsToLoad.length){
        createElement("div","sketch",$(elementsToLoad[b]).attr('d-px'),$(elementsToLoad[b]).attr('d-py'),$(elementsToLoad[b]).attr('d-pz'),$(elementsToLoad[b]).attr('d-pw'),
...
colorConsole("minY = "+minY,"lightgreen",475);
colorConsole("maxY = "+maxY,"orange",476);
//createElement("sending",$(element).attr('d-px'),$(element).attr('d-py'),$(element).attr('d-pz'),$(element).attr('d-pw'),
  //            $(element).attr('d-ph'),$(element).attr('d-html'));
    ...
    //define save
    element = document.createElement("br");
    element.setAttribute("d-px",minX);
    element.setAttribute("d-py",minY);
    element.setAttribute("d-pw",maxX-minX);
    element.setAttribute("d-ph",maxY-minY);
    element.setAttribute("d-pz",W/camProp.z);
    element.setAttribute("d-html","canvas");
    //console.log(element);
      minX=0;
      maxY=0;
      maxX=0;
